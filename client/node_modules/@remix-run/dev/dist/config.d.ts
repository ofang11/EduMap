...
import type * as ViteNode from "@remix-run/dev/dist/vite/vite-node";
import { type RouteManifest, type DefineRoutesFunction } from "@remix-run/dev/dist/config/routes";
...
export declare function logFutureFlagWarnings(future: Partial<FutureConfig>): void;
export { };
